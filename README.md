...
I am Adrian, an enthusiastic Software Developer and Firebird RDBMS contributor from Romania.
...
- ⚙️ C              ([php-firebird](https://github.com/mariuz/php-firebird))
- 💾 Shell          ([firebird-docker](https://github.com/mariuz/firebird-docker))
- 🦀 Rust           ([r2d2](https://github.com/mariuz/r2d2))
